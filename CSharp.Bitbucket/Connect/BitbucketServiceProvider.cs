...
using System;
using CSharp.Bitbucket.Api.Impl;
using CSharp.Bitbucket.Api.Interfaces;
using Spring.Social.OAuth1;

namespace CSharp.Bitbucket.Connect
{
    /// <summary>
	/// Bitbucket <see cref="IServiceProvider"/> implementation.
    /// </summary>
    /// <author>Scott Smith</author>
	public class BitbucketServiceProvider : AbstractOAuth1ServiceProvider<IBitbucket>
    {
        /// <summary>
		/// Creates a new instance of <see cref="BitbucketServiceProvider"/>.
        /// </summary>
		...
		public override IBitbucket GetApi(string accessToken, string secret)
        {
			return new BitbucketTemplate(ConsumerKey, ConsumerSecret, accessToken, secret);
        }
    }
}
