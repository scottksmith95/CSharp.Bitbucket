...
{
    /// <summary>
    /// The exception that is thrown when a error occurs while consuming Bitbucket REST API.
    /// </summary>
    /// <author>Scott Smith</author>
    [Serializable]
    public class BitbucketApiException : SocialException
    {
        private readonly BitbucketApiError _error;

        /// <summary>
        /// Gets the Bitbucket error.
        /// </summary>
        public BitbucketApiError Error
        {
            get { return _error; }
        }

        /// <summary>
        /// Creates a new instance of the <see cref="BitbucketApiException"/> class.
        /// </summary>
        /// <param name="message">A message about the exception.</param>
        /// <param name="error">The Bitbucket error.</param>
        public BitbucketApiException(string message, BitbucketApiError error)
            : base(message)
        {
            _error = error;
        }
        ...
        public BitbucketApiException(string message, Exception innerException)
            : base(message, innerException)
        {
            _error = BitbucketApiError.ServerError;
        }
